...
export const honestMath = {
  ...
  kicker: "There's now a faster way to the same — often better — result.",
};
...
export const oldVsNew = {
  ...
  line: "Same caliber of product. A fundamentally faster, leaner way to build it — and you get the upside: the speed and the savings, instead of an agency's margin.",
};

export const origin = {
  heading: "I've been on both sides of this.",
  body: "I founded and was CTO of a software agency — scaled it from 2 to 30 engineers and delivered 40+ production platforms for mostly-US clients. I know exactly what great delivery takes, and what it costs. When AI started changing what was possible, I didn't bolt it on — I rebuilt my entire development process around it. The result: three live products, built solo, at the quality bar I held my team to, in a fraction of the time.",
...
export const proof = {
  ...
  reviews: [
    {
      quote:
        "Did an excellent job with the delivery and implementation of milestones — took the extra time to understand the product design and what's best for the longer course of the project.",
      name: "",
...
export const freeValue = {
  ...
  secondary:
    "Prefer it in writing? Grab a free AI Build Audit — I'll send back the 3 highest-leverage moves for your product.",
